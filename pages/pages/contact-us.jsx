                ...
                <div className="row">
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-12 ">
                    <figure>
                      ...
                      <p>16 Iolaire Road, New Abbey, DG2 2SX</p>
                    </figure>
                  </div>
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-6 ">
                    <figure>
                      ...
                      <p>
                        <a href="#">suprolondon@example.com</a>
                      </p>
                    </figure>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-6 ">
                    <figure>
                      <figcaption>Email</figcaption>
                      <p>
                        <a href="#">suprosydsney@example.com</a>
                      </p>
                    </figure>
                  </div>
                </div>
