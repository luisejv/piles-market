        ...
        <Slider {...carouselSetting} className="ps-carousel">
          <div className="carousel-item">
            ...
            >
              <div className="ps-banner__content">
                ...
                <h5>
                  Slim fit gingham shirt with long sleeves <br /> button-up
                  fastening.
                </h5>
                <a
          ...
          <div className="carousel-item">
            ...
            >
              <div className="ps-banner__content">
                ...
                <h5>
                  Features collar with hood, zip and snap <br /> button
                  fastening.
                </h5>
                <a
                  className="ps-btn ps-btn--outline"
          ...
          <div className="carousel-item">
            ...
            >
              <div className="ps-banner__content">
                ...
                <h5>
                  Features button and zip fastening, side and <br /> chest
                  pockets and interior lining.
                </h5>
          ...
          <div className="carousel-item">
            <div
              className="ps-banner--3 classic small bg--top-right"
              style={{
                backgroundImage: `url(/static/img/banner/home-classic/6.jpg)`,
              }}
            >
              <div className="ps-banner__content">
                <p>Trending Now</p>
          ...
          <div className="carousel-item">
            <div
              className="ps-banner--3 classic small bg--top-right"
              style={{
                backgroundImage: `url(/static/img/banner/home-classic/7.jpg)`,
              }}
            >
              <div className="ps-banner__content">
                <p>Trending Now</p>
